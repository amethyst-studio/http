...
async function make() {
  const upstreamContent = readFileSync(resolve(__dirname, '../../sys/data/_.msf.json'))
  const jsonContent = readFileSync(resolve(__dirname, '../../conf.d/inject.json'))
  ...
  writeFileSync(resolve(__dirname, '../../sys/data/_r.msf.json'), JSON.stringify(final, null, 2))
}
